...
export const CULTURAL_SERIES: CulturalSeries[] = [
  {
    ...
    category: 'character',
    thumbnail: '/images/文创-乌萨奇正视图.jpg',
    mediaCount: 7,
  },
  {
    id: 'simpsons-bart',
    ...
    category: 'character',
    thumbnail: '/images/文创-辛普森一家巴特正视图.jpg',
    mediaCount: 7,
  },
  {
    id: 'simpsons-lisa',
    ...
    category: 'character',
    thumbnail: '/images/文创-辛普森一家丽莎正视图.jpg',
    mediaCount: 5,
  },
  {
    id: 'college-logo',
    ...
    category: 'logo',
    thumbnail: '/images/文创-学院logo正视图.jpg',
    mediaCount: 5,
  },
  {
    id: 'cat-dog',
    ...
    category: 'animal',
    thumbnail: '/images/文创-小猫小狗正视图.jpg',
    mediaCount: 5,
  },
]
...
export const CULTURAL_MEDIA: CulturalMedia[] = [
  ...
  },
  {
    id: 'usagi-parallel',
    type: 'image',
    path: '/images/文创-乌萨奇-平行偏振系统-正视图.jpg',
  ...
  },
  {
    id: 'usagi-crossed',
    type: 'image',
    path: '/images/文创-乌萨奇-正交偏振系统-正视图.jpg',
  ...
  },
  {
    ...
    type: 'video',
    path: '/videos/文创-乌萨奇-平行偏振系统-旋转样品视频.mp4',
    thumbnail: '/images/文创-乌萨奇-平行偏振系统-正视图.jpg',
  ...
  },
  {
    ...
    type: 'video',
    path: '/videos/文创-乌萨奇-正交偏振系统（横向）-旋转样品视频.mp4',
    thumbnail: '/images/文创-乌萨奇-正交偏振系统-正视图.jpg',
  ...
  },
  {
    ...
    type: 'video',
    path: '/videos/文创-乌萨奇-正交偏振系统（竖直）-旋转样品视频.mp4',
    thumbnail: '/images/文创-乌萨奇-正交偏振系统-正视图.jpg',
  ...
  },
  {
    id: 'bart-parallel',
    type: 'image',
    path: '/images/文创-辛普森一家巴特-平行偏振系统-正视图.jpg',
  ...
  },
  {
    id: 'bart-crossed',
    type: 'image',
    path: '/images/文创-辛普森一家巴特-正交偏振系统-正视图.jpg',
  ...
  },
  {
    ...
    type: 'video',
    path: '/videos/文创-辛普森一家巴特-平行偏振系统-旋转偏振片视频.mp4',
    thumbnail: '/images/文创-辛普森一家巴特-平行偏振系统-正视图.jpg',
  ...
  },
  {
    ...
    type: 'video',
    path: '/videos/文创-辛普森一家巴特-平行偏振系统-旋转样品视频.mp4',
    thumbnail: '/images/文创-辛普森一家巴特-平行偏振系统-正视图.jpg',
  ...
  },
  {
    ...
    type: 'video',
    path: '/videos/文创-辛普森一家巴特-正交偏振系统-旋转偏振片视频.mp4',
    thumbnail: '/images/文创-辛普森一家巴特-正交偏振系统-正视图.jpg',
  ...
  },
  {
    ...
    type: 'video',
    path: '/videos/文创-辛普森一家巴特-正交偏振系统-旋转样品视频.mp4',
    thumbnail: '/images/文创-辛普森一家巴特-正交偏振系统-正视图.jpg',
  ...
  },
  {
    id: 'lisa-parallel',
    type: 'image',
    path: '/images/文创-辛普森一家丽莎-平行偏振系统-正视图.jpg',
  ...
  },
  {
    id: 'lisa-crossed',
    type: 'image',
    path: '/images/文创-辛普森一家丽莎-正交偏振系统-正视图.jpg',
  ...
  },
  {
    ...
    type: 'video',
    path: '/videos/文创-辛普森一家丽莎-正交偏振系统-旋转偏振片视频.mp4',
    thumbnail: '/images/文创-辛普森一家丽莎-正交偏振系统-正视图.jpg',
  ...
  },
  {
    ...
    type: 'video',
    path: '/videos/文创-辛普森一家丽莎-正交偏振系统-旋转样品视频.mp4',
    thumbnail: '/images/文创-辛普森一家丽莎-正交偏振系统-正视图.jpg',
  ...
  },
  {
    id: 'logo-parallel',
    type: 'image',
    path: '/images/文创-学院logo-平行偏振系统-正视图.jpg',
  ...
  },
  {
    id: 'logo-crossed',
    type: 'image',
    path: '/images/文创-学院logo-正交偏振系统-正视图.jpg',
  ...
  },
  {
    ...
    type: 'video',
    path: '/videos/文创-学院logo-正交偏振系统-旋转偏振片视频.mp4',
    thumbnail: '/images/文创-学院logo-正交偏振系统-正视图.jpg',
  ...
  },
  {
    ...
    type: 'video',
    path: '/videos/文创-学院logo-正交偏振系统-旋转样品视频.mp4',
    thumbnail: '/images/文创-学院logo-正交偏振系统-正视图.jpg',
  ...
  },
  {
    id: 'catdog-parallel',
    type: 'image',
    path: '/images/文创-小猫小狗-平行偏振系统-正视图.jpg',
  ...
  },
  {
    id: 'catdog-crossed',
    type: 'image',
    path: '/images/文创-小猫小狗-正交偏振系统-正视图.jpg',
  ...
  },
  {
    ...
    type: 'video',
    path: '/videos/文创-小猫小狗-正交偏振系统-旋转偏振片视频.mp4',
    thumbnail: '/images/文创-小猫小狗-正交偏振系统-正视图.jpg',
  ...
  },
  {
    ...
    type: 'video',
    path: '/videos/文创-小猫小狗-正交偏振系统-旋转样品视频.mp4',
    thumbnail: '/images/文创-小猫小狗-正交偏振系统-正视图.jpg',
