...
export const CULTURAL_SERIES: CulturalSeries[] = [
  {
    ...
    category: 'character',
    thumbnail: '/images/chromatic-polarization/文创-乌萨奇正视图.webp',
    mediaCount: 7,
  },
  {
    id: 'simpsons-bart',
    ...
    category: 'character',
    thumbnail: '/images/chromatic-polarization/文创-辛普森一家巴特正视图.webp',
    mediaCount: 7,
  },
  {
    id: 'simpsons-lisa',
    ...
    category: 'character',
    thumbnail: '/images/chromatic-polarization/文创-辛普森一家丽莎正视图.webp',
    mediaCount: 5,
  },
  {
    id: 'college-logo',
    ...
    category: 'logo',
    thumbnail: '/images/chromatic-polarization/文创-学院logo正视图.webp',
    mediaCount: 5,
  },
  {
    id: 'cat-dog',
    ...
    category: 'animal',
    thumbnail: '/images/chromatic-polarization/文创-小猫小狗正视图.webp',
    mediaCount: 5,
  },
]
...
export const CULTURAL_MEDIA: CulturalMedia[] = [
  // ===== 乌萨奇 (Usagi) Series =====
  {
    id: 'usagi-front-1',
    type: 'image',
    path: '/images/chromatic-polarization/文创-乌萨奇正视图.webp',
  ...
  },
  {
    id: 'usagi-front-2',
    type: 'image',
    path: '/images/chromatic-polarization/文创-乌萨奇正视图（2）.webp',
  ...
  },
  {
    id: 'usagi-parallel',
    type: 'image',
    path: '/images/chromatic-polarization/文创-乌萨奇-平行偏振系统-正视图.webp',
  ...
  },
  {
    id: 'usagi-crossed',
    type: 'image',
    path: '/images/chromatic-polarization/文创-乌萨奇-正交偏振系统-正视图.webp',
  ...
  },
  {
    ...
    thumbnail: '/images/chromatic-polarization/文创-乌萨奇-平行偏振系统-正视图.webp',
  ...
  },
  {
    ...
    thumbnail: '/images/chromatic-polarization/文创-乌萨奇-正交偏振系统-正视图.webp',
  ...
  // ===== 辛普森一家巴特 (Simpsons Bart) Series =====
  {
    id: 'bart-front',
    type: 'image',
    path: '/images/chromatic-polarization/文创-辛普森一家巴特正视图.webp',
  ...
  },
  {
    id: 'bart-parallel',
    type: 'image',
    path: '/images/chromatic-polarization/文创-辛普森一家巴特-平行偏振系统-正视图.webp',
  ...
  },
  {
    id: 'bart-crossed',
    type: 'image',
    path: '/images/chromatic-polarization/文创-辛普森一家巴特-正交偏振系统-正视图.webp',
  ...
  },
  {
    ...
    thumbnail: '/images/chromatic-polarization/文创-辛普森一家巴特-平行偏振系统-正视图.webp',
  ...
  },
  {
    ...
    thumbnail: '/images/chromatic-polarization/文创-辛普森一家巴特-正交偏振系统-正视图.webp',
  ...
  // ===== 辛普森一家丽莎 (Simpsons Lisa) Series =====
  {
    id: 'lisa-front',
    type: 'image',
    path: '/images/chromatic-polarization/文创-辛普森一家丽莎正视图.webp',
  ...
  },
  {
    id: 'lisa-parallel',
    type: 'image',
    path: '/images/chromatic-polarization/文创-辛普森一家丽莎-平行偏振系统-正视图.webp',
  ...
  },
  {
    id: 'lisa-crossed',
    type: 'image',
    path: '/images/chromatic-polarization/文创-辛普森一家丽莎-正交偏振系统-正视图.webp',
  ...
  },
  {
    ...
    thumbnail: '/images/chromatic-polarization/文创-辛普森一家丽莎-正交偏振系统-正视图.webp',
  ...
  // ===== 学院Logo (College Logo) Series =====
  {
    id: 'logo-front',
    type: 'image',
    path: '/images/chromatic-polarization/文创-学院logo正视图.webp',
  ...
  },
  {
    id: 'logo-parallel',
    type: 'image',
    path: '/images/chromatic-polarization/文创-学院logo-平行偏振系统-正视图.webp',
  ...
  },
  {
    id: 'logo-crossed',
    type: 'image',
    path: '/images/chromatic-polarization/文创-学院logo-正交偏振系统-正视图.webp',
  ...
  },
  {
    ...
    thumbnail: '/images/chromatic-polarization/文创-学院logo-正交偏振系统-正视图.webp',
  ...
  // ===== 小猫小狗 (Cat & Dog) Series =====
  {
    id: 'catdog-front',
    type: 'image',
    path: '/images/chromatic-polarization/文创-小猫小狗正视图.webp',
  ...
  },
  {
    id: 'catdog-parallel',
    type: 'image',
    path: '/images/chromatic-polarization/文创-小猫小狗-平行偏振系统-正视图.webp',
  ...
  },
  {
    id: 'catdog-crossed',
    type: 'image',
    path: '/images/chromatic-polarization/文创-小猫小狗-正交偏振系统-正视图.webp',
  ...
  },
  {
    ...
    thumbnail: '/images/chromatic-polarization/文创-小猫小狗-正交偏振系统-正视图.webp',
