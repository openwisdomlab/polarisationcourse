...
const LEVELS: Level2D[] = [
  ...
  // === ICELAND SPAR SPECIAL LEVEL ===
  {
    ...
    nameZh: '冰洲石奇遇',
    description: 'Discover polarizing beam splitting: one light beam becomes two! Use the PBS to split and recombine light, inspired by Iceland spar birefringence.',
    descriptionZh: '探索偏振分束的奥秘：一束光变成两束！利用偏振分束器(PBS)分光并重新组合光束，灵感来自冰洲石的双折射。',
